...
const orientacoesPorEtapa: Record<string, string[]> = {
  prospeccao: [
    "Identifique o decisor e influenciadores chave",
    "Pesquise sobre a empresa e seus desafios",
    "Prepare uma abordagem personalizada",
    "Qualifique o potencial do lead"
  ],
  qualificacao: [
    "Confirme o orçamento disponível",
    "Identifique a urgência e timeline",
    "Valide se o produto atende às necessidades",
    "Mapeie todos os stakeholders envolvidos"
  ],
  proposta: [
    "Revise a proposta com o time comercial",
    "Certifique-se que todos os itens estão corretos",
    "Prepare argumentos para possíveis objeções",
    "Valide condições de pagamento e prazos"
  ],
  negociacao: [
    "Defina seu limite de desconto",
    "Prepare alternativas de condições de pagamento",
    "Mantenha contato frequente com o cliente",
    "Identifique pontos de flexibilização"
  ],
  fechamento: [
    "Confirme todos os dados para faturamento",
    "Verifique estoque e prazo de entrega",
    "Prepare a documentação necessária",
    "Alinhe expectativas de pós-venda"
  ],
  ganho: [
    "Confirme a data de entrega com o cliente",
    "Inicie o processo de faturamento",
  ...
  perdido: [
    ...
    "Identifique aprendizados para o futuro",
    "Planeje um follow-up adequado"
  ]
};
              ...
              {etapas.map((etapa, index) => {
                ...
                return (
                  <div
                    key={etapa.id}
                    className={cn(
                      "relative flex items-center justify-center h-9 flex-1 transition-all",
                      "clip-path-chevron",
