...
import type { CaixaTipo, OrdenacaoTipo, Contadores, Setor, Conta } from "@/hooks/useConversationFilters";
...
export function ConversationFilters({
  ...
  return (
    <div className="space-y-2 p-3 border-b bg-card">
      ...
      <div className="flex items-center gap-2">
        ...
        {totalNaoLidas > 0 && (
          <div className="relative">
            ...
            <Badge variant="destructive" className="absolute -top-2 -right-2 h-4 min-w-4 px-1 text-[10px] font-bold">
      ...
      <div className="flex items-center gap-2">
        <SetorSelector value={setorId} onChange={onSetorChange} setores={setores} isLoading={isLoadingSetores} />
      ...
      <div className="flex items-center justify-end">
        <OrdenacaoSelector value={ordenacao} onChange={onOrdenacaoChange} />
      </div>
    </div>
  );
}
