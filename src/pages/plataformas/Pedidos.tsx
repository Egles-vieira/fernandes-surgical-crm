  ...
  return (
    <div className="p-8 flex items-center justify-center min-h-[80vh]">
      <Card className="p-12 text-center max-w-md shadow-elegant">
        ...
        <h1 className="text-2xl font-bold text-primary mb-3">Pedidos de Plataforma</h1>
        <p className="text-muted-foreground">
          Módulo em desenvolvimento. Em breve você poderá gerenciar pedidos de plataformas aqui.
        </p>
      </Card>
    </div>
  );
