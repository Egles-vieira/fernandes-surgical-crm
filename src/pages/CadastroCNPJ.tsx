...
import { Building2, Search, AlertCircle, CheckCircle2, XCircle, Loader2, ArrowLeft, UserPlus } from "lucide-react";
...
export default function CadastroCNPJ() {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container mx-auto p-6 max-w-7xl">
        ...
        {(status === 'idle' || status === 'erro') && <Card className="mb-6 border-2">
            <CardHeader>
        ...
        {/* Progresso */}
        {status !== 'idle' && status !== 'concluido' && status !== 'erro' && <Card className="mb-6">
        ...
        {status === 'concluido' && dadosColetados && <div className="space-y-6">
            {/* Header de Ações */}
