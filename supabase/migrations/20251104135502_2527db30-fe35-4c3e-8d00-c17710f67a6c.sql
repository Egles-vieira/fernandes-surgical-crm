-- ============================================
-- MIGRAÇÃO: Sistema Inteligente de Cadastro via CNPJ
-- ============================================
...
-- Policies para cliente_enderecos
...
-- Policies para cliente_inscricoes_estaduais
...
-- Policies para cliente_api_logs
...
-- Policies para cliente_documentos
...
-- Policies para cnpja_configuracoes
