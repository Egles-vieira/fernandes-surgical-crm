-- Dropar e recriar funções com tipos corretos
DROP FUNCTION IF EXISTS public.buscar_produtos_similares(text,integer,real);
DROP FUNCTION IF EXISTS public.buscar_produtos_hibrido(text,text[],integer);

-- Recriar com tipos de retorno corretos (TEXT para evitar conflitos VARCHAR)
