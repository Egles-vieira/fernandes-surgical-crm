...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log('📤 Enviando vídeo via W-API, mensagemId:', mensagemId);
    ...
    const wapiUrl = `https://api.w-api.app/v1/message/send-video?instanceId=${conta.instance_id_wapi}`;
    ...
    console.log('✅ Vídeo enviado:', wapiData);
